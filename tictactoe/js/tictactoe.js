...
function placeXOrO(squareNumber) {
    //this condition ensures a square hasnt been previously selected
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === 'X') {
            ...
            select.style.backgroundImage = 'url("images/leo.png")';
            //Active player is either X or O si if not X then use O
        } else{
            //if activePlayer is equal to 'O' the O.png is added to array
            select.style.backgroundImage = 'url("images/footclan.png")';
        }
        //squareNumber and activePlayer are concatenated together and added to array
        selectedSquares.push(squareNumber + activePlayer);
        //calls a function to check for a win condition
        checkWinConditions();
        //this condition changes the active player
        if (activePlayer === 'X') {
        ...
        //returning true is needed for computers turn() function to work
        return true;
    }
...
function checkWinConditions() {
    ...
    //this functionchecks if an array contains 3 strings. it is used to check for
    //each win condition
...
function disableClick() {
    ...
    //this makes body clickable after 1 second
    ...
    //this function resets the game in th event of a tie or win
    function resetGame() {
